...
- Anti-Entropy: https://zklm.github.io/honkai-vn-antientropy/ (Standalone)
  ...
  - Chapters 13 to 14: done by listless-restless, based on extensive edits of work done by Aiatar and zklm 
      - For original work by Aiatar and zklm, use `master-old` branch. Do note that their translation is incomplete.
  - Chapters 15 to 26: partially done by Aiatar and zklm
